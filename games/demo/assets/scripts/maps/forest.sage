...
proc forest_init():
    ...
    ui_remove("pause_div")
    ui_set("hud_time_bg", "sprite", "panel_dark")
    ui_set("hud_player_bg", "sprite", "panel_dark")
    ui_set("pause_bg", "sprite", "panel_dark")
    ui_remove("pause_div")
    ui_set("hud_player_bg", "nine_slice", true)
    ui_set("hud_time_bg", "nine_slice", true)
    ui_set("pause_bg", "nine_slice", true)
    ui_panel("log_bg", 10, 900, 320, 160, "panel_scroll")
    ui_set("log_bg", "opacity", 0.750)
    ui_label("log_0", ">> Battle won! +50 XP", 20, 908, 0.70, 0.80, 0.70, 1.00)
    ui_set("log_0", "scale", 0.500)
    ui_label("log_1", ">> Found Iron Sword", 20, 932, 0.62, 0.70, 0.62, 0.88)
    ui_set("log_1", "scale", 0.500)
    ui_label("log_2", ">> Quest updated", 20, 956, 0.53, 0.61, 0.53, 0.76)
    ui_set("log_2", "scale", 0.500)
    ui_label("log_3", ">> Sam joined the party", 20, 980, 0.45, 0.51, 0.45, 0.64)
    ui_set("log_3", "scale", 0.500)
    ui_label("log_4", ">> Entered Mystic Forest", 20, 1004, 0.36, 0.42, 0.36, 0.52)
    ui_set("log_4", "scale", 0.500)
    ui_label("log_5", ">> Game saved", 20, 1028, 0.28, 0.32, 0.28, 0.40)
    ui_set("log_5", "scale", 0.500)
    ui_set("log_bg", "x", 10)
    ui_set("log_bg", "y", 895)
    ui_set("log_bg", "x", 736)
    ui_set("log_bg", "y", 901)
