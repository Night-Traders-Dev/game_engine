...
public:
    ...
    // Draw a rotated quad (rotation in degrees around center of quad)
    void draw_quad_rotated(Vec2 position, Vec2 size, Vec2 uv_min, Vec2 uv_max,
                           float rotation_deg, Vec4 color = Vec4(1.0f));
